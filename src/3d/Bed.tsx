  ...
  return (
    <group position={[2.2, 0, 1.5]}>
      ...
      <mesh position={[0, 0.65, -0.75]} castShadow>
        ...
        <meshStandardMaterial color="#ddd5c8" roughness={0.75} />
      </mesh>
      ...
      <mesh position={[0, 0.44, 0.18]}>
        ...
        <meshStandardMaterial color="#c0b4a2" roughness={0.85} />
      </mesh>
      <mesh position={[0, 0.46, 0.68]}>
        <boxGeometry args={[1.6, 0.05, 0.06]} />
        <meshStandardMaterial color="#c0b4a2" roughness={0.8} />
      </mesh>
      ...
      <mesh position={[-1.15, 0.75, -0.35]}>
        ...
        <meshStandardMaterial color="#f0e4d4" roughness={0.8} transparent opacity={0.85} side={THREE.DoubleSide} />
      </mesh>
    </group>
  )
}
